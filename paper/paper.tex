...
\verb|EMD.jl| is a Julia implementation of Empirical Mode Decomposition (EMD). EMD offers a data-driven approach for both time-frequency signal analysis and non-linear denoising schemes. Although the original algorithm has been extended to support multi-dimensional or noise-assisted decompositions, this package adapts the work of Rilling \textit{et al.}
\end{abstract}
